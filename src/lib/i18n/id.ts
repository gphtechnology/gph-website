export const id = {
  ...
  bookCounseling: {
    ...
    orTransferManual: "Atau transfer manual ke rekening berikut:",
    bankLabel: "Bank",
    accountNumberLabel: "No. Rekening",
    accountHolderLabel: "Atas Nama",
    uploadLabel: "Upload Bukti Pembayaran",
    uploadHint: "Screenshot bukti transfer/pembayaran (JPG/PNG).",
    paidButton: "Kirim Bukti Pembayaran",
    errorNoProof: "Upload bukti pembayaran dulu sebelum lanjut.",
    errorUploadFailed: "Gagal upload bukti pembayaran. Coba lagi.",
    ...
    expiredSubtitle:
      "Slot dilepas kembali karena pembayaran tidak diselesaikan dalam 3 menit.",
    retry: "Coba Lagi",
